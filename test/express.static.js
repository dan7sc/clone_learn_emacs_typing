...
describe('express.static()', function() {
	...
	it('should require root path to be strin', function() {
	...
	it('should nod choke on auth-looking URL', function(done) {
	    request(this.app)
		.get('//todo@txt')
	...
	it('should skip POST request', function(done) {
	    request(this.app)
		.post('/todo.txt')
		.expect(404, 'Not Found', done);
	});
	...
	describe('when true', function() {
		...
		it('should fall-throught when directory without slash', function(done) {
		    request(this.app)
			.get('/pets')
			.expect(404, 'Not Found', done);
		});
	...
	describe('when syntactially invalid', function() {
