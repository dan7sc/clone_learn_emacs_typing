...
describe('Router', function() {
    ...
    it('should support .use of other router', function(done) {
	const router = new Router();
	...
	it('should handle throwing in handler after async param', function(done) {
	    ...
	    router.handle({ url: '/boo', method: 'GET' }, {}, function() {});
	});
	...
	it('should ignore FQDN in seach', function(done) {
	...
	it('should  adjsut FQDN req.url', function(done) {
	...
	it('should call param when routing middleware', function(done) {
	    const router = new Router();
	...
	it('should only call onde per request', function(done) {
	    let count = 0;
