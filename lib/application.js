 ...
 *   - setup route reflextion methods
 *
 * @private
 */
...
/**
 * Dispatch a req, res pair into the application. Stars pipeline processing.
 *
 ...
 *
 * If the _fn_parameter is an express app, then it will be
 * mounted at the _route_specified.
 *
 * @public
 */
 ...
 * [Consolidate.js](http://github.com/tj/consolidate.js)
...
/**
 * Delegate `.VERB(...)` callst to `router.VERB(...)`.
 */
 ...
 * application (whick is a `Function`) as its
 * callback. If you wish to create both an HTTP
 * and HTPPS server you may do so with the "http"
 * and "https" modules as show here:
 *
 *    const http = require('http')
 *      , https = require('https')
